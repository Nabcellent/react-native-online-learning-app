...
const Header = () => (
    <View style={{
        ...
        <View style={{ flex: 1 }}>
            <Text style={{ ...FONTS.h2 }}>Hello, Lil Berry!</Text>
...
const StartLearning = () => (
    <ImageBackground source={images.featured_bg_image} style={{
        ...
        <View>
            ...
            <Text style={{ marginTop: SIZES.radius, color: COLORS.white, ...FONTS.body4 }}>By Lil Nabz</Text>
        </View>

        <Image source={images.start_learning} style={{ width: '100%', height: 110, marginTop: SIZES.padding }}/>
...
const Categories = () => (
    <Section title={'Categories'}>
        <FlatList horizontal data={dummyData.categories} listKey={'Categories'} keyExtractor={cat => `cat-${cat.id}`}
